...
- How we handle bigger UI changes (and how to decide what is big UI change) on the application components.
...
- http://docs.geoserver.org/latest/en/developer/policies/review.html
