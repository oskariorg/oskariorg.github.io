...
- layer selector implementation will be done by Dimenteq (https://github.com/oskariorg/oskari-docs/issues/61)
...
- layer selector OIP approved and tagged as roadmap item so it can be found through roadmap listing as new development
